    ...
    public class controllercliente
    {
        public async static Task<models.usuario_cliente> GetPosts(string correo)
        {
            ...
            try
            {
                ...
                {
                    HttpResponseMessage responseMessage = await client.GetAsync("https://7efd-170-83-119-110.ngrok-free.app/api/usuarios/" + correo);
        ...
        public async static Task<models.Msg> CreateEmple(models.usuario_cliente cliente)
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    responseMessage = await client.PostAsync("https://b6a2-170-83-119-109.ngrok-free.app/api/usuarios/store", stringContent);
