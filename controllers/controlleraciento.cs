    ...
    public class controlleraciento
    {
        public async static Task<List<models.acientos>> GetPosts()
        {
            ...
            try
            {
                ...
                {
                    HttpResponseMessage responseMessage = await client.GetAsync("https://b6a2-170-83-119-109.ngrok-free.app/api/acientos?id_pelicula=2&ciudad=San+Pedro+Sula&fecha=2024-03-01&hora=7:00pm");
