    ...
    public class controldetalle
    {
        public async static Task<models.acent> GetPosts(int id)
        {
            ...
            try
            {
                ...
                {
                    HttpResponseMessage responseMessage = await client.GetAsync("https://b6a2-170-83-119-109.ngrok-free.app/api/acientos/" + id);
        ...
        public async static Task<List<models.versanck>> Historialsnack(int id)
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    HttpResponseMessage responseMessage = await client.GetAsync("https://b6a2-170-83-119-109.ngrok-free.app/api/snack/" + id);
